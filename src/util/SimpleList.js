...
export default class InfinityList extends Component {
    ...
    _renderItem = ({ index, item }) => {
        ...
        //     inputRange,
        //     outputRange: [.2, .4, .6, 1, 1, 1, .6, .4, .2],
        //     extrapolate: 'clamp',
        // });

        // const scale = this.scrollY.interpolate({
        //     inputRange,
        //     outputRange: [.8, .7, .9, .95, 1, .95, .9, .8, .7],
        //     // extrapolate: 'clamp',
        // });

        // const translateY = this.scrollY.interpolate({
        //     inputRange,
        //     outputRange: [50, 15, 10, 5, 0, -5, -10, -25, -50],
        //     extrapolate: 'clamp',
        // });

        // const rotateX = this.scrollY.interpolate({
        //     inputRange,
        //     outputRange: ['-50deg', '-35deg', '-15deg', '-10deg', '0deg', '10deg', '15deg', '35deg', '50deg'],
        //     // extrapolate: 'clamp',
        // });
