        ...
        <Container>
            <InfinityList
                ...
                renderItem={({ item, index }) => (
                    <>
                        <RowButton title='SAFE NAME Position' />
                        <RoundButton text='Left' onPress={() => onChange(0)} color={ButtonColors.green} />
                        <RoundButton text='Right' onPress={() => onChange(1)} color={ButtonColors.red} />
                    </>
                )}
            />
